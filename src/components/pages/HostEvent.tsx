  ...
  return (
    <div className="min-h-screen bg-[#FFFFF0]" data-section="events">
        ...
        <div className="absolute inset-0 z-20 flex items-center justify-center">
          <div className="text-center text-white px-4">
            ...
            <p className="text-xl max-w-3xl mx-auto">
              Premium event spaces in Eldoret for workshops, product launches,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-[#5C4033]/70 mb-12">
              Whether you're planning a corporate event, workshop, product
              launch, or networking mixer, our flexible event spaces and
              professional support team ensure your event is a success.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#FFFFF0]">
        <div className="container mx-auto px-4">
          <div className="w-16 h-1 bg-[#D4AF37] mb-6 mx-auto" />
          <h2 className="text-center text-[#5C4033] mb-12">
            ...
            {venues.map((venue, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="text-2xl text-[#D4AF37] mb-4">
                    {venue.rate}
                  </div>
                  <p className="text-xs text-[#5C4033]/50 mb-4">
                    Per event / Customizable packages available
                  </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-center text-[#5C4033]/70 mb-12 max-w-2xl mx-auto">
              ...
              within 24 hours with a customized proposal and pricing.
            </p>

            <form
              onSubmit={handleSubmit}
              className="bg-[#FFFFF0] rounded-lg p-8 border border-[#5C4033]/10"
            >
              <div className="space-y-6">
                ...
                <p className="text-xs text-center text-[#5C4033]/60">
                  Our events team will respond within 24 hours with availability
                  and pricing
                </p>
              </div>
            </form>
