...
const articles = [
  ...
  },
  {
    ...
    title: "From Startup to Scale-up: Nairobi Entrepreneur's Journey at Finale",
  ...
  },
  {
    id: 6,
    category: "Inside Kenya Spaces",
    title: "Coffee Culture Meets Work Culture: Inside Finale's Restaurant",
...
const trendingPosts = [
  ...
  { title: "Best Lunch Spots Near Finale Eldoret", views: "1.5k" },
];
...
export function Magazine({ onNavigate = () => {} }: { onNavigate?: (page: string, articleId?: string) => void }) {
  ...
  return (
    <div className="min-h-screen bg-[#FFFFF0]" data-section="magazine">
        ...
        <section className="relative h-[600px] overflow-hidden" data-content="magazine">
          ...
          <div className="relative z-10 container mx-auto px-4 h-full flex items-end pb-16">
            <div className="max-w-3xl text-white">
              ...
              <Badge className="bg-white/20 backdrop-blur-sm text-white mb-4 ml-2">
                {featuredArticle.category}
              </Badge>
              <h1 className="text-5xl mb-4">{featuredArticle.title}</h1>
      ...
      {/* Category Filter */}
      <section className="py-6 bg-white sticky top-20 z-40 shadow-refined border-b border-[#5C4033]/10">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-3">
              <BookOpen className="w-5 h-5 text-[#D4AF37]" />
              <h2 className="text-xl text-[#5C4033]">Explore Stories</h2>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                {regularArticles.map((article) => (
                  <article
                    ...
                    className="bg-white rounded-lg overflow-hidden shadow-refined-lg hover:shadow-xl transition-all border border-[#5C4033]/10 group cursor-pointer"
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <h3 className="text-xl text-[#5C4033] mb-3 group-hover:text-[#D4AF37] transition-colors line-clamp-2">
                        {article.title}
                      </h3>
            ...
            <div className="space-y-8">
              {/* Newsletter Signup */}
              <div className="bg-gradient-to-br from-[#D4AF37] to-[#B8941F] rounded-lg p-6 shadow-refined-lg">
                <div className="flex items-center gap-3 mb-4">
                  <Mail className="w-6 h-6 text-[#5C4033]" />
                  <h3 className="text-xl text-[#5C4033]">Weekly Stories</h3>
                </div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-refined border border-[#5C4033]/10">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg text-[#5C4033]">Trending Now</h3>
                </div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-refined border border-[#5C4033]/10">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg text-[#5C4033]">Our Spaces</h3>
                </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-[#5C4033] mb-4">Share Your Success Story</h2>
            <p className="text-xl text-[#5C4033]/70 mb-8 max-w-2xl mx-auto">
              Are you building something amazing from Finale Workspace? We'd love to feature your journey 
