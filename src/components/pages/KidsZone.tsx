...
export function KidsZone({ onNavigate }: { onNavigate: (page: string) => void }) {
  const features = [
    {
      icon: Shield,
      title: "Safe & Secure",
  ...
  return (
    <div className="min-h-screen bg-[#FFFFF0]" data-section="spaces">
      ...
      <section className="relative h-[450px] overflow-hidden">
        ...
        <div className="absolute inset-0 z-20 flex items-center justify-center">
          <div className="text-center text-white px-4">
            ...
            <h1 className="text-5xl mb-4">Kids Zone</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-[#5C4033] mb-6">Work-Life Balance Made Easy</h2>
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div>
                <div className="text-3xl text-[#D4AF37] mb-2">2-10</div>
                <p className="text-sm text-[#5C4033]/70">Years Old</p>
              </div>
              <div>
                <div className="text-3xl text-[#D4AF37] mb-2">Mon-Sat</div>
                <p className="text-sm text-[#5C4033]/70">8AM - 6PM</p>
              </div>
              <div>
                <div className="text-3xl text-[#D4AF37] mb-2">Supervised</div>
      ...
      <section className="py-16 bg-[#FFFFF0]">
        <div className="container mx-auto px-4">
          <div className="w-16 h-1 bg-[#D4AF37] mb-6 mx-auto" />
          <h2 className="text-center text-[#5C4033] mb-12">Why Parents Love Our Kids Zone</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {features.map((feature, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-refined border border-[#5C4033]/10 hover:shadow-lg transition-shadow">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h2 className="text-[#5C4033] mb-6">Engaging Activities & Amenities</h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="h-64 rounded-lg overflow-hidden shadow-refined">
                  <img
                ...
                <div className="h-64 rounded-lg overflow-hidden shadow-refined mt-8">
                  <img
      ...
      <section className="py-16 bg-[#FFFFF0]">
        <div className="container mx-auto px-4">
          <div className="w-16 h-1 bg-[#D4AF37] mb-6 mx-auto" />
          <h2 className="text-center text-[#5C4033] mb-12">Flexible Pricing Options</h2>
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {pricingOptions.map((option, index) => (
              <div
                key={index}
                className="bg-white rounded-lg p-8 shadow-refined-lg border border-[#5C4033]/10 hover:border-[#D4AF37] transition-all text-center"
              >
                <h3 className="text-2xl text-[#5C4033] mb-2">{option.duration}</h3>
                <div className="text-4xl text-[#D4AF37] mb-4">{option.price}</div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-gradient-to-r from-[#D4AF37]/10 to-[#B8941F]/10 rounded-lg p-8 border-l-4 border-[#D4AF37]">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl text-[#5C4033] mb-3">Safety First</h3>
      ...
      <section className="py-16 bg-[#FFFFF0]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="w-16 h-1 bg-[#D4AF37] mb-6 mx-auto" />
            <h2 className="text-center text-[#5C4033] mb-4">Reserve Kids Zone</h2>
      ...
      <section className="py-16 bg-gradient-to-r from-[#D4AF37] to-[#B8941F]">
        <div className="container mx-auto px-4 text-center">
          <h3 className="text-[#5C4033] mb-4">Want to See the Kids Zone?</h3>
