...
const featuredSpaces = [
  ...
  },
  {
    ...
    description: "Private soundproof booths for focused calls and video meetings",
...
const upcomingEvents = [
  {
    ...
    description: "Watch emerging startups pitch their innovative ideas to investors and mentors",
    category: "Networking"
  },
  {
    ...
    description: "Learn advanced strategies to grow your business online with industry experts",
    category: "Workshop"
  },
  {
    ...
    description: "Connect with fellow female entrepreneurs over a premium lunch experience",
    category: "Community"
  }
];
...
const magazineArticles = [
  {
    ...
    image: "https://images.unsplash.com/photo-1559310451-19481b3c7ec8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb3dvcmtpbmclMjBzcGFjZSUyMHBlb3BsZSUyMHdvcmtpbmd8ZW58MXx8fHwxNzYyMjQwNDI2fDA&ixlib=rb-4.1.0&q=80&w=1080",
    excerpt: "Discover how successful professionals are maximizing productivity in flexible workspaces...",
    slug: "5-tips-productive-remote-work"
  },
  {
    title: "How Sarah Built Her Tech Startup at Finale",
    category: "Success Stories",
    image: "https://images.unsplash.com/photo-1720700126957-769e2f2fc0fc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxrZW55YSUyMGJ1c2luZXNzJTIwdGVhbSUyMGNvbGxhYm9yYXRpb258ZW58MXx8fHwxNzYyMjQwNDI0fDA&ixlib=rb-4.1.0&q=80&w=1080",
    excerpt: "From a one-person team to a thriving 15-member company, here's Sarah's inspiring journey...",
    slug: "sarah-tech-startup-story"
  },
  {
    title: "The Future of Coworking in East Africa",
    category: "Inside Kenya Spaces",
    image: "https://images.unsplash.com/photo-1750124662229-47a8e16b8f14?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjB3b3Jrc3BhY2UlMjBjb21tdW5pdHl8ZW58MXx8fHwxNzYyMjAwMDY1fDA&ixlib=rb-4.1.0&q=80&w=1080",
    excerpt: "Exploring the trends shaping workspace design and business culture across Kenya and beyond...",
...
export function HomePage({ onNavigate }: { onNavigate: (page: string) => void }) {
  ...
  const prevSpace = () => {
    setCurrentSpaceIndex((prev) => (prev - 1 + featuredSpaces.length) % featuredSpaces.length);
  };

  return (
    <div className="min-h-screen">
      {/* Trust Indicators Bar */}
      <div className="bg-white border-b border-[#5C4033]/10" data-section="trust-bar">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-baseline gap-1">
                ...
                <span className="text-xs text-[#5C4033]/60">Active Members</span>
              </div>
            </div>
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-baseline gap-1">
                ...
                <span className="text-xs text-[#5C4033]/60">Private Offices</span>
              </div>
            </div>
            <div className="flex items-center gap-2">
      ...
      <section className="relative h-[600px] overflow-hidden" data-section="hero">
        ...
        <div className="absolute top-0 left-0 w-96 h-96 bg-[#D4AF37]/5 rounded-full blur-3xl z-[15] pointer-events-none animate-pulse" style={{ animationDuration: '4s' }} />
        
        {/* Ambient Light Flare - Bottom Right */}
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-[#D4AF37]/5 rounded-full blur-3xl z-[15] pointer-events-none animate-pulse" style={{ animationDuration: '6s', animationDelay: '1s' }} />
          ...
          >
            ...
            <div className="absolute inset-0 z-20 flex flex-col justify-center items-center">
              <div className="container mx-auto px-4">
                {/* Row 1: Hero Text Content - Centered with refined typography */}
                <div className="text-white text-center mb-10 animate-in fade-in slide-in-from-top-4 duration-700">
                  <p className="text-sm md:text-base mb-3 opacity-80 tracking-wide uppercase text-[#D4AF37]/90" style={{ letterSpacing: '0.1em' }}>
                    {slide.subtitle}
                  </p>
                  <h1 className="text-4xl md:text-5xl lg:text-6xl mb-6 drop-shadow-2xl" style={{ fontWeight: 600, lineHeight: 1.2 }}>
                    {slide.title}
                  </h1>
                </div>

                {/* Row 2: Booking Form Pill - Centered with slide-up animation */}
                <div className= "hidden lg:flex justify-center w-full max-w-6xl mx-auto animate-in fade-in slide-in-from-bottom-8 duration-700" style={{ animationDelay: '200ms' }}>
      ...
      {/* Mobile Booking Form */}
      <section className="lg:hidden py-8 bg-white" data-section="mobile-booking">
        <div className="container mx-auto px-4">
          <BookingForm variant="hero" />
        </div>
      </section>
      ...
      <section className="py-16 bg-[#FFFFF0]" data-section="intro-about">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-[#5C4033] mb-4">A Space Where Productivity Meets Comfort in Kenya</h2>
            <p className="text-[#5C4033]/80">
              Finale Workspace Kenya redefines professional environments in Eldoret. We combine 
              world-class amenities with authentic Kenyan hospitality to create spaces where 
              businesses thrive and communities flourish.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="p-8 text-center border-[#5C4033]/10 bg-white hover:shadow-lg transition-all" data-card="who-we-are">
              ...
              <p className="text-sm text-[#5C4033]/70 mb-4">
                Kenya's premier luxury workspace provider, offering flexible solutions for modern professionals and businesses.
              </p>
            </Card>

            <Card className="p-8 text-center border-[#5C4033]/10 bg-white hover:shadow-lg transition-all" data-card="our-mission">
              <div className="w-16 h-16 bg-[#D4AF37]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <Target className="w-8 h-8 text-[#D4AF37]" />
              </div>
              <h3 className="text-[#5C4033] mb-3">Our Mission</h3>
              <p className="text-sm text-[#5C4033]/70 mb-4">
                To empower entrepreneurs and teams with inspiring workspaces that foster collaboration, innovation, and success.
              </p>
            </Card>

            <Card className="p-8 text-center border-[#5C4033]/10 bg-white hover:shadow-lg transition-all" data-card="our-vision">
              <div className="w-16 h-16 bg-[#D4AF37]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <Heart className="w-8 h-8 text-[#D4AF37]" />
              </div>
              <h3 className="text-[#5C4033] mb-3">Our Vision</h3>
              <p className="text-sm text-[#5C4033]/70 mb-4">
                To be East Africa's most trusted and innovative workspace brand, setting new standards in business hospitality.
              </p>
            </Card>
          </div>
      ...
      <section className="py-16 bg-white" data-section="featured-spaces">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-[#5C4033] mb-4">Explore Our Premium Spaces</h2>
            <p className="text-[#5C4033]/70 max-w-2xl mx-auto">
              From private offices to collaborative areas, discover workspace solutions designed for every need
            </p>
          </div>
            ...
            {featuredSpaces.map((space, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-sm text-[#5C4033]/70 mb-4">{space.description}</p>
                  <Button 
          ...
          <div className="md:hidden relative">
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-[#5C4033] mb-2">{featuredSpaces[currentSpaceIndex].title}</h3>
                <p className="text-sm text-[#5C4033]/70 mb-4">{featuredSpaces[currentSpaceIndex].description}</p>
                <Button 
                  onClick={() => onNavigate(featuredSpaces[currentSpaceIndex].link)}
                  variant="ghost" 
                  className="text-[#D4AF37] hover:bg-[#D4AF37]/10 p-0"
                >
                  Book Now <ArrowRight className="w-4 h-4 ml-2" />
      ...
      <section className="py-16 bg-[#FFFFF0]" data-section="why-choose-us">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-[#5C4033]/70 max-w-2xl mx-auto">
              Experience the difference that premium amenities and thoughtful design make
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center group" data-feature="flexible-plans">
              ...
              <p className="text-sm text-[#5C4033]/70">
                Daily, monthly, or yearly memberships that adapt to your business needs
              </p>
            </div>
            ...
            <div className="text-center group" data-feature="prime-locations">
              ...
              <p className="text-sm text-[#5C4033]/70">
                Strategically located in Eldoret's most accessible business district
              </p>
            </div>
            ...
            <div className="text-center group" data-feature="modern-design">
              ...
              <p className="text-sm text-[#5C4033]/70">
                Aesthetically stunning spaces with ergonomic furniture and natural lighting
              </p>
            </div>
      ...
      <section className="relative py-32 bg-fixed bg-center bg-cover" data-section="spaces-in-action"
        style={{
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            <h2 className="text-white mb-4">Work, Connect, and Grow in Style</h2>
            <p className="text-xl mb-8 text-white/90">
              See how our members are transforming their businesses in inspiring environments
            </p>
      ...
      <section className="py-16 bg-white" data-section="reviews">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-[#5C4033]/70 max-w-2xl mx-auto">
              Real stories from real members who've grown their businesses with us
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="relative" data-review="1">
              ...
              />
              <p className="text-xs text-[#5C4033]/50 text-center mt-2">Member since Jan 2024</p>
            </div>
            ...
            <div className="relative" data-review="2">
              ...
              />
              <p className="text-xs text-[#5C4033]/50 text-center mt-2">Member since Mar 2023</p>
            </div>
            ...
            <div className="relative" data-review="3">
              ...
              />
              <p className="text-xs text-[#5C4033]/50 text-center mt-2">Member since Jul 2024</p>
            </div>
          </div>
      ...
      <section className="py-16 bg-[#FFFFF0]" data-section="events-preview">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-[#5C4033] mb-4">Upcoming Events & Workshops</h2>
            <p className="text-[#5C4033]/70 max-w-2xl mx-auto">
              Connect, learn, and grow with our community through exclusive networking events and educational workshops
            </p>
          </div>
      ...
      <section className="py-16 bg-white" data-section="magazine-highlights">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-[#5C4033]/70 max-w-2xl mx-auto">
              Insights, inspiration, and success stories from the Finale community
            </p>
          </div>
            ...
            {magazineArticles.map((article, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-sm text-[#5C4033]/70 mb-4">{article.excerpt}</p>
                  <Button 
                    variant="ghost" 
                    className="text-[#D4AF37] hover:bg-[#D4AF37]/10 p-0"
                  >
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl text-white">
            ...
            <h2 className="text-white mb-4">Fuel Your Day at Our Restaurant & Café</h2>
            <p className="text-xl mb-6 text-white/90">
              From artisan coffee to gourmet lunches, enjoy premium dining without leaving your workspace
            </p>
      ...
      <section className="py-20 bg-gradient-to-br from-[#5C4033] via-[#4A3329] to-[#5C4033]" data-section="join-community">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            <Globe className="w-16 h-16 text-[#D4AF37] mx-auto mb-6" />
            <h2 className="text-white mb-4">Your Next Great Idea Deserves the Right Space</h2>
            <p className="text-xl mb-8 text-white/90">
              Join a thriving community of entrepreneurs, freelancers, and established businesses 
              in Kenya's most inspiring workspace
            </p>
