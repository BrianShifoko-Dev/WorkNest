  ...
  export function HomePage({ onNavigate }: { onNavigate: (page: string) => void }) {
    ...
    return (
      <div className="min-h-screen">
        ...
        <div className="bg-white border-b border-[#5C4033]/10 pt-2" data-section="trust-bar">
        ...
        <section className="relative h-[600px] overflow-hidden" data-section="hero">
          ...
          <div className="hidden lg:flex absolute bottom-12 left-0 right-0 z-30 justify-center pointer-events-none">
        ...
        <section className="py-16 bg-[#FFFFF0] px-[0px] py-[48px]" data-section="intro-about">
          <div className="container mx-auto px-4">
        ...
        <section className="py-16 bg-white px-[0px] py-[32px]" data-section="featured-spaces">
          <div className="container mx-auto px-4">
        ...
        <section className="py-16 bg-white px-[0px] py-[48px]" data-section="reviews">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
        ...
        <section className="py-16 bg-[#FFFFF0] px-[0px] py-[48px]" data-section="events-preview">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
