...
export function TelephoneBooths({ onNavigate }: { onNavigate: (page: string) => void }) {
  const features = [
    {
      icon: Lock,
  ...
  return (
    <div className="min-h-screen bg-[#FFFFF0]" data-section="spaces">
      <Breadcrumbs
        items={[{ name: "Products & Book" }, { name: "Telephone Booths" }]}
      ...
      <section className="relative h-[450px] overflow-hidden">
        ...
        <div className="absolute inset-0 z-20 flex items-center justify-center">
          <div className="text-center text-white px-4">
            ...
            <h1 className="text-5xl mb-4">Private Telephone Booths</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-[#5C4033] mb-6">Privacy When You Need It Most</h2>
      ...
      <section className="py-16 bg-[#FFFFF0]">
        <div className="container mx-auto px-4">
          <div className="w-16 h-1 bg-[#D4AF37] mb-6 mx-auto" />
          <h2 className="text-center text-[#5C4033] mb-12">Designed for Privacy & Comfort</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {features.map((feature, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-refined border border-[#5C4033]/10">
                ...
                <h3 className="text-lg text-[#5C4033] mb-2">{feature.title}</h3>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="w-16 h-1 bg-[#D4AF37] mb-6 mx-auto" />
            <h2 className="text-center text-[#5C4033] mb-12">Perfect For</h2>
            <div className="grid md:grid-cols-2 gap-6">
              {useCases.map((useCase, index) => (
                ...
                >
                  ...
                  <div>
                    <h3 className="text-lg text-[#5C4033] mb-2">{useCase.title}</h3>
      ...
      <section className="py-16 bg-[#FFFFF0]">
        <div className="container mx-auto px-4">
          <div className="w-16 h-1 bg-[#D4AF37] mb-6 mx-auto" />
          <h2 className="text-center text-[#5C4033] mb-12">Affordable Hourly Rates</h2>
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {pricing.map((option, index) => (
              <div
                key={index}
                className={`bg-white rounded-lg p-8 shadow-refined-lg border-2 transition-all text-center ${
                  option.popular
              ...
              >
                ...
                <h3 className="text-2xl text-[#5C4033] mb-2">{option.duration}</h3>
                <div className="text-4xl text-[#D4AF37] mb-6">{option.price}</div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="w-16 h-1 bg-[#D4AF37] mb-6 mx-auto" />
            <h2 className="text-center text-[#5C4033] mb-12">How to Use Our Phone Booths</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="w-16 h-16 bg-[#D4AF37]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl text-[#D4AF37]">1</span>
                </div>
                <h3 className="text-lg text-[#5C4033] mb-2">Book or Walk In</h3>
              ...
              <div className="text-center">
                <div className="w-16 h-16 bg-[#D4AF37]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl text-[#D4AF37]">2</span>
                </div>
                <h3 className="text-lg text-[#5C4033] mb-2">Enter & Lock</h3>
                <p className="text-sm text-[#5C4033]/70">
              ...
              <div className="text-center">
                <div className="w-16 h-16 bg-[#D4AF37]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl text-[#D4AF37]">3</span>
                </div>
                <h3 className="text-lg text-[#5C4033] mb-2">Make Your Call</h3>
                <p className="text-sm text-[#5C4033]/70">
      ...
      <section className="py-16 bg-[#FFFFF0]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="w-16 h-1 bg-[#D4AF37] mb-6 mx-auto" />
            <h2 className="text-center text-[#5C4033] mb-4">Reserve a Phone Booth</h2>
