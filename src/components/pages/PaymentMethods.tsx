...
export function PaymentMethods({ onNavigate }: { onNavigate: (page: string) => void }) {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-white/90">
              Choose your preferred payment method for Finale Workspace bookings
            </p>
          </div>
        </div>
      </section>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                          ...
                          <div className="flex-1">
                            <Label htmlFor="mpesa" className="cursor-pointer">
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-[#5C4033]">M-Pesa</span>
                              </div>
                          ...
                          <div className="flex-1">
                            <Label htmlFor="card" className="cursor-pointer">
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-[#5C4033]">Card</span>
                              </div>
                              <p className="text-xs text-[#5C4033]/60">
                          ...
                          <div className="flex-1">
                            <Label htmlFor="bank" className="cursor-pointer">
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-[#5C4033]">Bank Transfer</span>
                              </div>
                              <p className="text-xs text-[#5C4033]/60">
                  ...
                  {paymentMethod === "mpesa" && (
                    <div className="bg-[#FFFFF0] p-6 rounded-lg border border-[#5C4033]/10">
                      <h3 className="text-[#5C4033] mb-4 flex items-center gap-2">
                        <Smartphone className="w-5 h-5 text-[#D4AF37]" />
                      ...
                      <div className="space-y-4">
                        <div className="bg-white p-4 rounded border border-[#D4AF37]/30 mb-4">
                          ...
                          <div className="space-y-1 text-sm text-[#5C4033]/70">
                            ...
                            <p><strong>Account Name:</strong> Finale Workspace Ltd</p>
