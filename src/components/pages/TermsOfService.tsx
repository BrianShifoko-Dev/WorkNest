            ...
            <div className="bg-white rounded-lg shadow-lg border border-[#5C4033]/10 p-8 md:p-12 space-y-8">
              ...
              <div>
                <h2 className="text-[#5C4033] mb-4">
                  Welcome to Finale Workspace
                </h2>
                <p className="text-[#5C4033]/80 leading-relaxed">
                  These Terms of Service ("Terms") govern your use of Finale
                  Workspace facilities, services, and amenities located in
              ...
              <div>
                ...
                <p className="text-[#5C4033]/80 leading-relaxed mb-3">
                  By booking, accessing, or using any Finale Workspace services,
              ...
              <div>
                ...
                <p className="text-[#5C4033]/80 leading-relaxed mb-3">
                  Finale Workspace is not liable for loss, theft, or damage to
              ...
              <div>
                ...
                <p className="text-[#5C4033]/80 leading-relaxed">
                  All Finale Workspace branding, logos, website content, and
              ...
              <div>
                ...
                <p className="text-[#5C4033]/80 leading-relaxed mb-3">
                  ...
                  notice. Finale Workspace reserves the right to immediately
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-[#5C4033]/80">
                      <p>
                        <strong>Email:</strong> legal@finaleworkspace.co.ke
                      </p>
                      <p>
